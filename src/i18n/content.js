      ...
      items: [
        {
          ...
          bullets: [
            ...
            'Monitor recharge reconciliations end to end, watching for missing data, mismatches, failed transactions and automatic rollbacks, so customers are always treated fairly and Digicel keeps its revenue safe.',
      ...
      items: [
        {
          ...
          bullets: [
            ...
            'Surveiller les réconciliations de recharges de bout en bout, en traquant les données manquantes, les écarts, les transactions échouées et les rollbacks automatiques, pour que le client ne subisse aucune injustice et que Digicel sécurise ses revenus.',
